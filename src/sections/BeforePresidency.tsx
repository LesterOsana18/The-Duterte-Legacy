const BeforePresidency = () => {
  ...
  return (
    ...
    >
      <div className="w-full min-h-screen grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2">
        
        {/* Left Panel: Image */}
        <div className="relative w-full h-[40vh] sm:h-[50vh] md:h-full">
          <img
        ...
        <div className="flex flex-col justify-center p-4 sm:p-6 md:p-8 lg:px-12 text-content">
          <h2 className="text-2xl sm:text-3xl md:text-4xl mb-6 text-white font-bold">
            Before the Presidency
            <span className="block text-lg sm:text-xl text-gray-400 mt-2 font-light">
              The Davao Years
            </span>
          </h2>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-x-2 gap-y-1">
            ...
            <a 
              ...
              className="text-xs sm:text-sm text-gray-500 hover:underline transition"
            >  
              BBC Report
            </a>
          ...
          <button 
            ...
            className="mt-6 sm:mt-8 inline-block px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm text-white 
              bg-red-600 rounded-full hover:text-red-600 hover:bg-white transition-all duration-300
