const CallToAction = () => {
  return (
    <section
      ...
      className="min-h-screen grid md:grid-cols-2 bg-black text-white"
    >
      {/* Left Side: Image */}
      ...
      {/* Right Side: Content */}
      <div
        className="flex flex-col justify-center bg-black items-start px-8 md:px-12 py-8"
      >
        {/* Title */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-start gap-4">
          <a
            ...
            className="inline-block px-6 py-3 rounded-md bg-red-700 hover:bg-red-600 text-white text-sm font-semibold transition"
          >
            Learn the Facts
          </a>
          <a
            ...
            className="inline-block px-6 py-3 rounded-md bg-gray-50 hover:bg-gray-300 text-gray-900 text-sm font-semibold transition"
